...
export default function Footer() {
  ...
  const serviceLinks = [
    { name: 'Cloud-Lösungen', href: '#cloud' },
    { name: 'Data & Analytics', href: '#data' },
    { name: 'KI & Machine Learning', href: '#ai' },
    { name: 'IT-Strategie', href: '#strategy' },
    { name: 'IT-Sicherheit', href: '#security' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div>
              <h4 className="text-sm font-semibold mb-4">Folgen Sie uns</h4>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 IT Semantic. Alle Rechte vorbehalten.
          </p>
        </div>
      </div>
    </footer>
